...
<div class="bg-white/5 border border-white/10 rounded-3xl shadow-2xl p-8 md:p-12 space-y-6 text-center backdrop-blur">
    ...
    <div class="space-y-2">
        <p class="text-sm font-semibold text-red-300">403</p>
        <h1 class="text-3xl md:text-4xl font-semibold">Akses ditolak</h1>
        <p class="text-white/70">Anda tidak memiliki izin untuk membuka halaman ini.</p>
    </div>
